...
def job_statistics_dashboard(request):
    ...
    return render(request, 'app/dashboard.html', {'plot_div': plot_div})
...
def top_companies_view(request):
    ...
    return render(request, 'app/top_companies.html')
...
def top_industries_salary_chart(request):
    ...
    return render(request, 'app/top_industries_salary_chart.html', {'chart_image': image_base64})
...
def job_analysis(request):
    ...
    # Step 4: Categorize description lengths
    bins = [0, 500, 1000, 1500, 2000, df['description_length'].max()]
    ...
    return render(request, 'app/job_analysis.html', {
...
def job_posting_efficacy(request):
    ...
    return render(request, 'app/job_posting_efficacy.html', {
...
def company_characteristics(request):
    ...
    return render(request, 'app/company_characteristics.html', context)
...
def job_statistics(request):
    ...
    return render(request, 'app/job_statistics_dashboard.html', {'plot_div': plot_div})

def top_companies_dashboard(request):
    # Render the initial template with the default number of companies
    return render(request, 'app/top_companies_dashboard.html')

def industry_pie_chart(request):
    return render(request, 'app/industry_pie_chart.html')
